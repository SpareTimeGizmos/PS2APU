//++
//scancode.c - PS/2 scan codes to ASCII translation table (UK version!)
//
...
//  4-May-19	TAF	Create UK version.
// 12-May-24	RLA	SDCC version (thanks Todd!).
//--
...
//	 YES	  YES	      3
//--
PUBLIC uint8_t const __code g_abScanCodes[128][4] = {
{{     0},{    0},{     0},{    0}},	// 00 - (unused)
{{     0},{    0},{     0},{    0}},	// 01 - F9
{{     0},{    0},{     0},{    0}},	// 02 
{{     0},{    0},{     0},{    0}},	// 03 - F5
